...
public class SetAttributeSubIfcStructuralLinearAction {
	// fields
	...
	// constructors
	public SetAttributeSubIfcStructuralLinearAction() {
	}

	public SetAttributeSubIfcStructuralLinearAction(Object object, String attributeName, String attributeNewValue) {
		this.object = object;
	...
	public void setAttribute() {
		if (attributeName.equals("ProjectedOrTrue")) {
			...
			//5NoEList
			((IfcStructuralLinearAction) object).setObjectType(attributeNewValue);
			 //5void
			 //5String
		}
			...
			//5NoEList
			((IfcStructuralLinearAction) object).setName(attributeNewValue);
			 //5void
			 //5String
		}
		else if (attributeName.equals("Description")) {
			//5NoEList
			((IfcStructuralLinearAction) object).setDescription(attributeNewValue);
			 //5void
			 //5String
		}
		else {
