...
public class SetAttributeSubIfcStructuralPlanarAction {
	// fields
	...
	// constructors
	public SetAttributeSubIfcStructuralPlanarAction() {
	}

	public SetAttributeSubIfcStructuralPlanarAction(Object object, String attributeName, String attributeNewValue) {
		this.object = object;
	...
	public void setAttribute() {
		if (attributeName.equals("ProjectedOrTrue")) {
			//1NoEList
			 //1void
			...
			//5NoEList
			((IfcStructuralPlanarAction) object).setObjectType(attributeNewValue);
			 //5void
			 //5String
		}
			...
			//5NoEList
			((IfcStructuralPlanarAction) object).setName(attributeNewValue);
			 //5void
			 //5String
		}
		else if (attributeName.equals("Description")) {
			//5NoEList
			((IfcStructuralPlanarAction) object).setDescription(attributeNewValue);
			 //5void
			 //5String
		}
		else {
