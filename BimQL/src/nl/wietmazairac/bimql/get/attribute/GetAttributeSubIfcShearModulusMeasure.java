...
public class GetAttributeSubIfcShearModulusMeasure {
	// fields
	private Object object;
	private String string;

	// constructors
	public GetAttributeSubIfcShearModulusMeasure(Object object, String string) {
		this.object = object;
		this.string = string;
	}
	...
	ArrayList<Object> resultList = new ArrayList<Object>();
		if (string.equals("WrappedValue")) {
			...
			resultList.add(((IfcShearModulusMeasure) object).getWrappedValueAsString());
			 //1String
		}
		return resultList;
	}
